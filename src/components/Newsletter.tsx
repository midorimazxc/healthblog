  ...
  return (
    <section className="glass-strong relative overflow-hidden rounded-[28px] p-8 sm:p-12">
      ...
      <div className="relative max-w-2xl">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs text-white/85 ring-1 ring-white/20">
        ...
        {done ? (
          <p className="mt-6 rounded-2xl bg-[#22c55e]/15 px-4 py-3 text-white ring-1 ring-[#22c55e]/40">
          ...
          >
            <input
              ...
              className="glass flex-1 rounded-full px-5 py-3 text-white placeholder:text-white/50 outline-none focus:ring-2 focus:ring-[#22c55e]/50"
            />
